...
<section class="profile-store__board">
	<div class="profile-store__figure">
		<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/profile/store-image.jpg' ?>"
			width="88" height="88" alt="Eden_Star" class="profile-store__image">
	...
	<div class="profile-store__heading store__heading--verified">
		<h1 class="profile-store__name">Eden_Star</h1>
	...
	<div calss="profile-store__subheading">
	...
	<div class="profile-store__description">
		<p>לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית סחטיר בלובק. תצטנפל בלינדו למרקל אס לכימפו, דול, צוט
			ומעיוט.</p>
	</div>
	...
	<div class="profile-products profile-products--swipe">
		<div class="profile-product">
			<div class="profile-product__media">
				...
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-3.webp' ?>"
					alt="product 1" class="profile-product__image">
			</div>
		...
		<div class="profile-product">
			<div class="profile-product__media">
				...
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-1.webp' ?>"
					alt="product 1" class="profile-product__image">
			</div>
			<div class="profile-product__details">
				<p class="profile-product__tag-rent">השכרה</p>
		...
		<div class="profile-product">
			<div class="profile-product__media">
				...
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-9.webp' ?>"
					alt="product 1" class="profile-product__image">
			</div>
			<div class="profile-product__details">
				<p class="profile-product__tag-rent">השכרה</p>
		...
		<div class="swap-tab-panel active" id="tab1">
			...
			<div class="all-charts">
				...
				<div class="balance">
					<div class="count"></div>
					<img class="reports-placeholder"
						src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/reports/gen-report-3.svg' ?>"
						alt="">
				</div>
				<div class="rating">
					...
					<img class="reports-placeholder"
						src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/reports/gen-report-4.svg' ?>"
						alt="">
				</div>
			</div>
			...
			<section class="dashboard-returned-buyers">
				<div class="dashboard__section-heading">
					<h2 class="dashboard__section-title">לקוחות מובילים
						<span>עלייה/16<svg width="18" height="18" viewBox="0 0 18 18" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<path
...
<section class="profile-product-comments">
	...
	<div class="profile-product-comments-list">
		<div class="profile-product-comment">
			<div class="profile-product-comment__header">
				<p class="profile-product-comment__details">
					<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/profile/profile-image-4.webp' ?>"
						alt="" width="20" height="20" class="dashboard__author-image">
		...
		<div class="profile-product-comment">
			...
			<div class="profile-product-comment__product-images">
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-2.webp' ?>"
					alt="product 3" class="profile-product-comment__product-image">
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-2.webp' ?>"
					alt="product 3" class="profile-product-comment__product-image">
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-2.webp' ?>"
					alt="product 3" class="profile-product-comment__product-image">
		...
		<div class="profile-product-comment">
			...
			<div class="profile-product-comment__product-images">
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-3.webp' ?>"
					alt="product 2" class="profile-product-comment__product-image">
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-3.webp' ?>"
					alt="product 2" class="profile-product-comment__product-image">
				<img src="<?php echo get_stylesheet_directory_uri() . '/assets/dist/images/sections/products/product-3.webp' ?>"
					alt="product 2" class="profile-product-comment__product-image">
