<div class="modal-you-must-log-in-wrap">
    <div class="modal-you-must-log-in">
        ...
        <h2><?php esc_html_e("שימי לב, כדי להשלים את התהליך יש להתחבר לחשבון Swap שלך"); ?></h2>

        <div class="nav-list">
            <div>
                <p><?php esc_html_e("יש לך חשבון?") ?></p>
                <a class="black" href="<?php echo home_url("login") ?>"><?php esc_html_e("יש לך חשבון?") ?></a>
            </div>

            <div>
                <p><?php esc_html_e("יש לך חשבון?") ?></p>
                <a class="brown" href="<?php echo home_url("customer-registration") ?>"><?php esc_html_e("יש לך חשבון?") ?></a>
            </div>
        </div>
