                    ...
                    if (!empty($grouped_categories)) {
                        foreach ($grouped_categories as $letter => $categories) {
                            ...
                            foreach ($categories as $category) {
                                echo '<li data-type="brands" class="' . ($category->term_id == $product_brand_id ? "active" : "") . '" data-name="' . $category->name . '" data-child-id="' . $category->term_id . '"><span class="name">' . esc_html($category->name) . '</span></li>';
                            }
                        }
                    }
                    ?>
...
<input class="selected-filters" type="text" name="brands-term-id" hidden data-type="brands" data-title="" value="<?php echo esc_html($product_brand_id); ?>">