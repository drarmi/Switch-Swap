...
<input id="selected-form-color" require style="display: none;" type="text" name="color-term" value=""/>
<input id="selected-form-color-name" require style="display: none;" type="text" name="color-term-name" value=""/>
<input id="selected-form-color-hex" require style="display: none;" type="text" name="color-term-name-hex" value=""/>