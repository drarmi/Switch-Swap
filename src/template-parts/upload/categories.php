        ...
        foreach ($parent_categories as $parent) {
            ...
            if (!empty($child_categories) && !is_wp_error($child_categories)) {
                ...
                foreach ($child_categories as $child) {
                    echo '<li data-type="category" data-name="' . $child->name . '" data-slug="' . $child->slug . '" data-id="' . $child->term_id . '">' . esc_html($child->name) . '</li>';
                }
                echo '</ul>';
            }
        }
...
<input id="selected-form-category"  style="display: none;" type="text" name="category-term" value=""/>
<input id="selected-form-category-name"  style="display: none;" type="text" name="category-name" value=""/>