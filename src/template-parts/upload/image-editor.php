<div id="images-modal" class="modal modal-step" data-step="3">
    <div class="modal-content">
        <div class="modal-content-top">
            ...
            <div class="roll-back-js" data-step="2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal-content-body">
            <h2><?php esc_html_e("תמונות להעלאה", "swap") ?></h2>
            <p><?php esc_html_e("בגרירה ניתן למקם את התמונות הנבחרות", "swap") ?></p>
            ...
            <?php get_template_part("src/template-parts/upload/nav-btn", null); ?>
        </div>
        ...
        <div class="control-element-wrap">
            ...
            <input type="file" id="select-images-one" accept="image/*" class="hidden" name="new-product-images">
        </div>
    </div>
</div>